...
import { FaCity, FaEnvelope, FaMapMarkerAlt, FaPhone, FaUser } from 'react-icons/fa';
...
const Inventory = () => {
  ...
  // };
  return (
    <section class="min-h-screen flex items-center justify-center p-3">
      <div className="w-full max-w-5xl bg-white/80 backdrop-blur-lg rounded-xl shadow-sm p-6 md:p-10 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col justify-center space-y-5">
          ...
          <div className="bg-gray-50 p-4 rounded-xl border border-gray-100 text-sm text-gray-600 space-y-2">
            <p>
              <span className="font-extrabold text-orange-500">O</span> Fast Delivery
            </p>
            <p>
              <span className="font-extrabold text-orange-500">O</span> Secure Checkout
            </p>
            <p>
              <span className="font-extrabold text-orange-500">O</span> Easy Return Policy
            </p>
          </div>
        </div>
