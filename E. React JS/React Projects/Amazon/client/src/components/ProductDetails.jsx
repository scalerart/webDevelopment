      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center justify-between">
        ...
        <div className="grid gap-6 items-center justify-center">
          <div className="bg-white rounded-xl sm:rounded-2xl overflow-hidden p-6 m-auto">
            <img src={img} className="w-80 object-cover hover:scale-105 transition duration-500" />
          </div>
        ...
        <div className="bg-white p-4 sm:p-6 lg:p-8 rounded-xl sm:rounded-2xl">
          ...
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800 mb-3 line-clamp-3">
            {name}
          </h1>
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3">
              {sizes.map((size) => (
                <button
                  ...
                  className={`w-10 h-10 text-sm rounded-full border border-gray-300 transition cursor-pointer ${
                    selectedSize === size ? 'bg-orange-500 text-white' : 'hover:bg-gray-100'
                  }`}
                >
                  {size}
                </button>
