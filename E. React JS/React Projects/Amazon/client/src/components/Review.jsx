...
import { getShoppingCart, removeFromDb } from '../utilities/databaseManager';
        ...
        <div className="lg:col-span-3 space-y-4 ">
          ...
          {cart.map((pd) => (
            ...
            >
              ...
              <div className="w-24 h-24 flex-shrink-0">
                <img src={pd.img} alt={pd.name} className="w-full h-full object-cover rounded-lg" />
              </div>
          ...
          {orderPlaced && (
            <div className="flex justify-center items-center bg-white p-6 rounded-xl shadow mt-6">
              <img src={happyImage} alt="Order Success" className="w-full max-w-md rounded-xl" />
            </div>
          )}
        </div>
